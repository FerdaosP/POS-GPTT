// File: /src/purchaseOrder/AddPurchaseOrderForm.jsx
...
const AddPurchaseOrderForm = ({ isOpen, onClose, onSave }) => {
    ...
    return (
       <Modal show={isOpen} onHide={onClose} centered className="modal-premium" style={{ zIndex: 1060 }} dialogClassName="modal-xl" >
                         ...
                         <Row>
                              <Col md={6}>
                                 <Form.Group className="mb-3">
                                    ...
                                    <Form.Control type="text" name="poNumber" value={form.poNumber} onChange={handleChange} required className="input-premium" />
                                  </Form.Group>
                              </Col>
                              <Col md={6}>
                                 <Form.Group className="mb-3">
